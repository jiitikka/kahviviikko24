...
const Footer = () => {
  return (
    <div className='w-full flex flex-row flex-wrap items-center justify-center bg-brand-pink text-white gap-4 lg:gap-10 p-4 lg:p-10'>
      ...
      <a className='flex justify-center align-middle items-center rounded-full m-2 border-2 border-brand-pink hover:border-white hover:text-brand-pink' href='#home'>
