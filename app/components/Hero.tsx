...
const Hero = () => {
  return (
    <div className='z-0 h-screen bg-beans-bg-image bg-cover bg-fixed relative' id="home">
        ...
        <div className='z-20 flex flex-col gap-10 h-full w-full items-center justify-center opacity-100 bg-white/50 md:bg-transparent p-4 md:p-16 lg:p-40 2xl:px-80'>
            <Image className='z-30 h-auto w-auto max-w-7xl' width={1121} height={640} alt="Tampereen Kahviviikko Logo" src={"/TKV24 Logo.svg"}></Image>
