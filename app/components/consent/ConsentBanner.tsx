...
const ConsentBanner = ({
  ...
  <div
    ...
    className="pointer-events-none fixed inset-x-0 bottom-0 z-[90] flex justify-center p-[clamp(12px,3vw,24px)]"
  >
    <div
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex min-w-0 flex-col gap-2">
          <h2 className="m-0 font-display text-[clamp(18px,3vw,21px)] font-extrabold tracking-[-0.02em] text-coffee">
